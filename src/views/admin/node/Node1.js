  ...
  <>
    ...
    <tr>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <p>
          Gain Rasio :{api?.node1?.result?.contactWithConfirm?.batuk?.gainRasio}
        </p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <p>
          Gain Rasio :{api?.node1?.result?.contactWithConfirm?.demam?.gainRasio}
        </p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <p>
          Gain Rasio :
          {api?.node1?.result?.contactWithConfirm?.sakitTenggorokan?.gainRasio}
        </p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :
          {api?.node1?.result?.contactWithConfirm?.sesakNafas?.sesakNafas.total}
        </p>
        <p>
          Positive :
          {
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :
          {
            api?.node1?.result?.contactWithConfirm?.sesakNafas?.tidakSesakNafas
              .total
          }
        </p>
        <p>
    ...
    <tr>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <p>Positive :{api?.node1?.result?.other?.batuk?.tidakBatuk.Positive}</p>
        <p>Negative :{api?.node1?.result?.other?.batuk?.tidakBatuk.Negative}</p>
        <p>Hasil : {api?.node1?.result?.other?.batuk?.hasil}</p>
        <p>Gain Rasio :{api?.node1?.result?.other?.batuk?.gainRasio}</p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <p>Positive :{api?.node1?.result?.other?.demam?.tidakDemam.Positive}</p>
        <p>Negative :{api?.node1?.result?.other?.demam?.tidakDemam.Negative}</p>
        <p>Hasil : {api?.node1?.result?.other?.demam?.hasil}</p>
        <p>Gain Rasio :{api?.node1?.result?.other?.demam?.gainRasio}</p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :
          {api?.node1?.result?.other?.sakitTenggorokan?.sakitTenggorokan.total}
        </p>
        <p>
          Positive :
          {
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>Total :{api?.node1?.result?.other?.sesakNafas?.sesakNafas.total}</p>
        <p>
          Positive :{api?.node1?.result?.other?.sesakNafas?.sesakNafas.Positive}
        </p>
        <p>
          Negative :{api?.node1?.result?.other?.sesakNafas?.sesakNafas.Negative}
        </p>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :{api?.node1?.result?.other?.sesakNafas?.tidakSesakNafas.total}
        </p>
        <p>
          Positive :
    ...
    <tr>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <p>Gain Rasio :{api?.node1?.result?.abroad?.sakitKepala?.gainRasio}</p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :
          {api?.node1?.result?.abroad?.sakitTenggorokan?.sakitTenggorokan.total}
        </p>
        <p>
          Positive :
          {
        ...
        <p>
          Gain Rasio :{api?.node1?.result?.abroad?.sakitTenggorokan?.gainRasio}
        </p>
      </td>
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :
          {
            api?.node1?.result?.abroad?.sakitTenggorokan?.tidakSakitTenggorokan
              .total
          }
        </p>
        <p>
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>Total :{api?.node1?.result?.abroad?.sesakNafas?.sesakNafas.total}</p>
        <p>
          Positive :
      ...
      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        <p>
          Total :{api?.node1?.result?.abroad?.sesakNafas?.tidakSesakNafas.total}
        </p>
        <p>
          Positive :
